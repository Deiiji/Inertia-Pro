...
bool LLPluginClassMedia::init(const std::string &launcher_filename, const std::string &plugin_filename, bool debug, const std::string &user_data_path, U32 priority)
{	
	...
	mPlugin->init(launcher_filename, plugin_filename, debug, user_data_path, priority);
